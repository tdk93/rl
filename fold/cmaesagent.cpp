...
CMAESAgent::CMAESAgent(const int &numFeatures, const int &numActions, const unsigned long int &totalEpisodes, const int &generations, const int &evalEpisodes, const int &randomSeed) : Agent(numFeatures, numActions, randomSeed){
...
CMAESAgent::CMAESAgent(const int &numFeatures, const int &numActions, const unsigned long int &totalEpisodes, const int &generations, const int &evalEpisodes, const int &randomSeed, const vector<double> &startMean, const vector<double> &startVariance) : Agent(numFeatures, numActions, randomSeed){
