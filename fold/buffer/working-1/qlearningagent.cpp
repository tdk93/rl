...
QLearningAgent::QLearningAgent(const int &numFeatures, const int &numActions, const double &alphaStart, const double &epsilonStart, const int &randomSeed) : Agent(numFeatures, numActions, randomSeed){
