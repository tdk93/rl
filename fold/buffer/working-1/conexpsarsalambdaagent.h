#ifndef CONEXPSARSALAMBDAAGENT_H
#define CONEXPSARSALAMBDAAGENT_H
...
class ConExpSarsaLambdaAgent : public Agent{
 ...
 public:
  ...
  ConExpSarsaLambdaAgent(const int &numFeatures, const int &numActions, const double &lambda, const double &alphaInit, const double &epsInit, const int &randomSeed);
  ~ConExpSarsaLambdaAgent();
