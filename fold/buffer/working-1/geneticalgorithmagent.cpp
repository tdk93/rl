...
GeneticAlgorithmAgent::GeneticAlgorithmAgent(const int &numFeatures, const int &numActions, const int &popSize, const int &evalEpisodes, const int &randomSeed) : Agent(numFeatures, numActions, randomSeed){
